<template>
  ...
  >
    ...
    <div ref="borderWidget" style="position: absolute; width: 100%; display: table; height: 100%">
      <div
        style="display: table-cell; vertical-align: middle"
        :style="{
          background: item.bgcolor,
          border: item.borderWidth + 'px ' + item.borderType + ' ' + item.borderColor,
          borderRadius: item.borderRadius + 'vw',
          boxShadow: item.shadowX + 'vw ' + item.shadowY + 'vw ' + item.shadowWidth + 'vw ' + item.shadowColor,
        }"
      ></div>
    </div>
  </div>
...
export default {
  ...
  mounted: function () {
    this.theBorder = this.item.borderWidth + "px " + this.item.borderType + " " + this.item.borderColor;
    this.theBoxShadow = this.item.shadowX + "px " + this.item.shadowY + "px " + this.item.shadowWidth + "px " + this.item.shadowColor;
    console.log(this.item.bgcolor);
  },
...
<style slot-scope lang="scss"></style>
