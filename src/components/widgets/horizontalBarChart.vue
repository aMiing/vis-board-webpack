<template>
  ...
  >
    <div class="btn" title="复制" style="position: absolute; left: 0; top: 0; z-index: 99; background: #6bf; font-size: 1vw">
    ...
    >
      <ve-bar :data="chartData" :width="chartWidth" :height="chartHeight" :extend="chartExtend" :settings="chartSettings"></ve-bar>
    </div>
  </div>
</template>
