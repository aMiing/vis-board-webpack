<template>
  ...
  >
    <div class="btn" style="position: absolute; left: 0; top: 0; z-index: 99; background: #6bf; font-size: 1vw">
      ...
      <div class="delete btn" @click="deleteIt" title="删除" style="cursor: pointer; float: left; padding: 2px">
    ...
    >
      <ve-histogram :data="chartData" :width="chartWidth" :height="chartHeight" :extend="chartExtend" :settings="chartSettings"></ve-histogram>
    </div>
  </div>
</template>
  ...
  methods: {
    MoveIt: function (e) {
      ...
      document.onmousemove = e => {
        ...
        this.$emit("changePosition", { uid: this.item.uid, left: leftNum, top: topNum });
      };
