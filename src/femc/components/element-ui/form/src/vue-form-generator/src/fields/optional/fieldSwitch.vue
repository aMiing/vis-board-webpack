...
.vue-form-generator .field-switch {
  ...
  .handle {
    ...
    background: linear-gradient(to bottom, var(--grey-13) 40%, #f0f0f0);
    background-image: -webkit-linear-gradient(top, var(--grey-13) 40%, #f0f0f0);
    border-radius: 100%;
  ...
  .handle:before {
    ...
    width: 12px;
    height: 12px;
    background: linear-gradient(to bottom, #eeeeee, var(--grey-13));
    background-image: -webkit-linear-gradient(top, #eeeeee, var(--grey-13));
    border-radius: 6px;
